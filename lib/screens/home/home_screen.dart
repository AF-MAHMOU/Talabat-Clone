                                      ...
                                      return ListTile(
                                        ...
                                        onTap: () async {
                                          ...
                                          for (var addr in addresses.docs) {
                                            await addr.reference.update({'isDefault': false});
                                          }
                            ...
                            children: [
                              ...
                              StreamBuilder<QuerySnapshot>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  final address = snapshot.data!.docs.first.data() as Map<String, dynamic>;
                                  return Row(
                                    children: [
                                      Expanded(
                                        child: Text(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      TextButton(
                        onPressed: () {
                          // Navigate to Talabat Mart section
                        },
                    ...
                    builder: (context, recentSnapshot) {
                      ...
                      return StreamBuilder<DocumentSnapshot>(
                        ...
                        builder: (context, restaurantSnapshot) {
                          final restaurantName = restaurantSnapshot.data?.get('name') as String? ?? 'Restaurant';
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      status == 'preparing' ? 'Order is being prepared' : 'Order is on the way',
                                      style: const TextStyle(
                                        fontWeight: FontWeight.bold,
                                        fontSize: 16,
                                      ),
                  ...
                  SizedBox(
                    ...
                    child: ListView(
                      ...
                      children: [
                        ...
                        _buildCategoryCard('Burgers', Icons.lunch_dining, 'Burgers'),
                        _buildCategoryCard('Pizza', Icons.local_pizza, 'Pizza'),
                        _buildCategoryCard('Sushi', Icons.set_meal, 'Sushi'),
                        _buildCategoryCard('Desserts', Icons.icecream, 'Desserts'),
                        _buildCategoryCard('Drinks', Icons.local_drink, 'Drinks'),
                      ],
                    ),
                  ),
                ],
...
class WavePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (double i = 0; i < size.width; i++) {
      path.lineTo(
        i,
        size.height * 0.8 + math.sin((i / size.width * 2 * math.pi) + (math.pi / 2)) * 10,
      );
    }
