...
class SeedData {
  ...
  static Future<void> seedMartItems() async {
  final firestore = FirebaseFirestore.instance;

  // Clear existing mart items
  final martItemsSnapshot = await firestore.collection('martItems').get();
  for (var doc in martItemsSnapshot.docs) {
    await doc.reference.delete();
  }
  ...
  final martItems = [
    {
      'name': 'Bananas',
      'description': 'Fresh Egyptian bananas, 1kg',
      'price': 14.99,
      'imageUrl': 'https://images.unsplash.com/photo-1574226516831-e1dff420e12c?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80',
      'category': 'Fruits',
      'inStock': true,
      'quantity': 100,
    },
    {
      'name': 'Milk (1L)',
      'description': 'Full-fat milk, 1 liter',
      'price': 18.50,
      'imageUrl': 'https://images.unsplash.com/photo-1582719478250-dcdbb3e7cb5b?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80',
      'category': 'Dairy',
      'inStock': true,
      'quantity': 200,
    },
    {
      ...
      'price': 22.00,
      'imageUrl': 'https://images.unsplash.com/photo-1585238342027-4aa1bff7fb84?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80',
      'category': 'Beverages',
      'inStock': true,
      'quantity': 80,
    },
    {
      'name': 'Potato Chips',
      'description': 'Salted classic potato chips',
      'price': 8.75,
      'imageUrl': 'https://images.unsplash.com/photo-1585238342027-4aa1bff7fb84?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80',
      'category': 'Snacks',
      'inStock': true,
  ...
  for (var item in martItems) {
    await firestore.collection('martItems').add(item);
  }
}
